                    ...
                    success: function (data) {
                        ...
                        response($.map(data.response.minivenues, function (item) {
                            return {
                                ...
                                category : (item.categories && item.categories[0]) ? item.categories[0].name : '',
                                ...
                                photo: (item.categories && item.categories[0]) ? (item.categories[0].icon.prefix + "32" + item.categories[0].icon.name) : '', 
                                full: item
                            };
                        }));
                    },
